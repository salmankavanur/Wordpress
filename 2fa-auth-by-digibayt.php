 ...
 * Text Domain:       2fa-auth-by-digibayt
...
function wp_2fa_auth_digibayt_register_menu() {
	...
	add_menu_page(
		esc_html__( '2FA Auth', '2fa-auth-by-digibayt' ),
		esc_html__( '2FA Auth', '2fa-auth-by-digibayt' ),
...
function wp_2fa_auth_digibayt_render_admin() {
	echo '<div class="wrap">';
	echo '<div id="digibayt-2fa-admin"><p>' . esc_html__( 'Loading Security Dashboard...', '2fa-auth-by-digibayt' ) . '</p></div>';
	echo '</div>';
}
...
function wp_2fa_auth_digibayt_action_links( $links ) {
	$settings_link = '<a href="' . admin_url( 'admin.php?page=wp-2fa-auth' ) . '">' . __( 'Settings', '2fa-auth-by-digibayt' ) . '</a>';
